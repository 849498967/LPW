    ...
    for each_lot in lot_list:
        ...
        for each_sh_folder in sh_folder_list:
            ...
            if match_res:
                ...
                print("!!!!!!!!!!!!Find SH datalog folder for lot: %s!!!!!!!!!!!!!" % match_res.group(0))
                    ...
                    with open(sh_log_path + "\\" + each_site, "r") as f:
                        ...
                        for log in f:
                            ...
                            if match_869:
                                ...
                                key = "_".join(["TOUCHDOWN"+str(touch_down), dut, channel, chip])
                                # print(key)
                                ...
                                for each_die in die_temp_list:
                                    ...
                                    if wxyl_match:
                                        ...
                                        if key not in tb__869_dict:
                                            ...
                                            print("No WXY find!")
                                            temp = touch_down - 1
                                            temp_key = "_".join(["TOUCHDOWN" + str(temp), dut, channel, chip])
...
if __name__ == "__main__":
    ...
    path = "C:\\Users\\1000277162\\Desktop\\B4 long power down issue\\Calypso\\cal last 3 months.txt"
    # get all the lots
    all_lot_list = extract_lot(path)
    main_dir = 'C:\\Users\\1000277162\\Desktop\\B4 long power down issue\\Calypso\\PERIOD1'
