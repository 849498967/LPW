                    ...
                    for each_site in sh_log_list:
                        ...
                        with open(sh_log_path + "\\" + each_site, "r") as f:
                            for log in f:
                                ...
                                if match_869:
                                    # set to 0 when we got a 869 failure
                                    no_869_fail_but_has_553_fail_flag = 0
                                    tb__869_detect = 1
                        ...
                        if tb__869_dict:
                            print("Summary for lof file %s:" % each_site)
...
if __name__ == "__main__":
    ...
    path = "C:\\Users\\1000277162\\Desktop\\B4 long power down issue\\Cal X 8D 512G\\cal x.txt"
    # get all the lots
    all_lot_list = extract_lot(path)
    main_dir = 'C:\\Users\\1000277162\\Desktop\\B4 long power down issue\\Cal X 8D 512G\\April-May-June'
